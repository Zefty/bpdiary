        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent className="w-screen p-0">
                <div className="grid gap-2 pb-6 pt-4">
                    <DropDownMenuLink href="#" className="focus:bg-transparent ml-4 ">
...
const DropDownMenuLink = ({
    ...
    return (
        <DropdownMenuItem asChild>
            <Link href={href} className={cn(mobileNavigationStyle(), className)} {...props}>
                {children}
            </Link>
        </DropdownMenuItem>
    )
...
const mobileNavigationStyle = cva("flex w-full items-center py-2 text-lg font-semibold");

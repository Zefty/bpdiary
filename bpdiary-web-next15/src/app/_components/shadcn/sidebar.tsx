...
>(
  (
    ...
    useEffect(() => {
      ...
      window.addEventListener("mouseup", handleTrackStop);

      window.addEventListener("touchmove", handleTouchMove);
      window.addEventListener("touchend", handleTrackStop);

      return () => {
        window.removeEventListener("mousemove", handleMouseMove);
        window.removeEventListener("mouseup", handleTrackStop);
    ...
    return (
      <>
        ...
        <div
          ref={ref}
          className="group peer text-sidebar-foreground laptop:block hidden"
          data-state={state}
          ...
          {resizable && (
            <div
              ...
              className={cn(
                ...
                variant === "floating" || variant === "inset"
                  ? "left-[calc(var(--sidebar-width)_+_0.5rem_-_var(--sidebar-resize-handle-width))] group-data-[collapsible=icon]:left-[calc(var(--sidebar-width-icon)_-_var(--sidebar-resize-handle-width)_+_0.65rem)]"
                  : "left-[calc(var(--sidebar-width)_-_var(--sidebar-resize-handle-width))] group-data-[collapsible=icon]:left-[calc(var(--sidebar-width-icon)_-_var(--sidebar-resize-handle-width))]",
                !isMobile && !isTablet
                  ? ""
            ...
            >
              <div
                className="hover:bg-border group-data-[track=true]:bg-border h-full rounded-md transition-colors"

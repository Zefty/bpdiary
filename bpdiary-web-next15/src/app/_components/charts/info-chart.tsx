...
export default function InfoChart() {
  ...
  return (
    <Card className="flex flex-col">
      ...
      <CardContent className="flex flex-1 flex-col items-center py-6">
        <span>
          Avg. Systolic: {Math.round(Number(viewData?.avgSystolic))} mmHg
        </span>
        <span>
          Avg. Diastolic: {Math.round(Number(viewData?.avgDiastolic))} mmHg
        </span>
